  ...
  return (
    ...
    >
      <img
        ...
        className="object-contain  shrink-0 w-8 max-xl:w-7 max-lg:w-4 max-lg:mt-[7px] max-sm:mt-[3px] aspect-square"
      />
      <div className="flex-1 shrink basis-0 max-md:max-w-full max-sm:leading-5">
        {feature.description}
      </div>
    </div>
  );
